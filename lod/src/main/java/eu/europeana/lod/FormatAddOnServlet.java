...
public class FormatAddOnServlet extends HttpServlet
{
    ...
    public void init(ServletConfig config) throws ServletException
    {
        ...
        String        ext    = config.getInitParameter("req_extension");
        ...
        throws ResponseThrowable
    {
        ...
        catch (IOException e) { throw new ResponseThrowable(502); }
        ...
        catch (RiotException e) { throw new ResponseThrowable(e, 502); }
    }
    ...
    private void writeResponse(Model m, HttpServletResponse rsp
