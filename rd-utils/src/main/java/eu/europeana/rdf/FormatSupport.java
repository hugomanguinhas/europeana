...
//, TRIX     ("trix"  , "TriX"                 , "application/trix+xml")
  ;
    ...
    public static String getJenaLangByMime(String mime)
    {
        FormatSupport support = getFormatByMime(mime);
        return ( support == null ? null : support.getJenaFormat()
                                                 .getLang().getLabel() );
    }
